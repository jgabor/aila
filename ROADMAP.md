...
Verification command: go test ./internal/agent ./internal/runtime ./internal/tui -count=1; go test ./internal/... -count=1; mage check; git diff --check -- ROADMAP.md .agentera/plan.yaml .agentera/progress.yaml internal/agent internal/runtime internal/tui; git diff --check --no-index /dev/null <each new agent/streaming fixture file>; uv run /home/jgabor/.local/share/agentera/app/scripts/agentera plan --format json; uv run /home/jgabor/.local/share/agentera/app/scripts/agentera progress --format json.
...
Verification command: go test ./internal/agent ./internal/runtime ./internal/app ./internal/tui ./cmd/aila -count=1; go test ./internal/... -count=1; mage check; git diff --check -- ROADMAP.md .agentera/plan.yaml .agentera/progress.yaml go.mod go.sum internal/agent internal/runtime internal/app internal/tui cmd/aila; git diff --check --no-index /dev/null <each new M24 source/fixture file>; uv run /home/jgabor/.local/share/agentera/app/scripts/agentera plan --format json; uv run /home/jgabor/.local/share/agentera/app/scripts/agentera progress --format json.
...
Verification command: go test ./internal/runtime ./internal/tui ./internal/app ./cmd/aila -count=1; go test ./internal/... -count=1; mage check; git diff --check -- ROADMAP.md .agentera/plan.yaml .agentera/progress.yaml internal/runtime internal/app internal/tui cmd/aila; git diff --check --no-index /dev/null <each new M25 fixture file>; uv run /home/jgabor/.local/share/agentera/app/scripts/agentera plan --format json; uv run /home/jgabor/.local/share/agentera/app/scripts/agentera progress --format json.
...
Verification command: go test ./internal/permission ./internal/runtime ./internal/app ./internal/tui ./cmd/aila -count=1; go test ./internal/... -count=1; mage check; git diff --check -- ROADMAP.md .agentera/plan.yaml .agentera/progress.yaml internal/permission internal/runtime internal/app internal/tui cmd/aila; git diff --check --no-index /dev/null <each new M26 fixture file>; uv run /home/jgabor/.local/share/agentera/app/scripts/agentera plan --format json; uv run /home/jgabor/.local/share/agentera/app/scripts/agentera progress --format json.
