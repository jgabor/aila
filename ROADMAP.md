...
| Field                    | Value                                                                                                                                                                                                                                                                                                                                                                      |
| ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Last completed milestone | Milestone 20: Safe Bash Inspection                                                                                                                                                                                                                                                                                                                                         |
| Next milestone           | Milestone 21: Fetch Tool                                                                                                                                                                                                                                                                                                                                                   |
| Active milestone         | none                                                                                                                                                                                                                                                                                                                                                                       |
| Last updated             | 2026-05-16                                                                                                                                                                                                                                                                                                                                                                 |
| Last validation          | M20 safe bash contract and executor tests, app/runtime bash-effect and permission metadata tests, command render/semantic tests, command-result/command-failure/command-running/tool-failed fixtures and snapshots, PTY smoke skipped because no visible shell command path exists, full `mage check`, architecture checklist evidence, and `git diff --check` all passed. |
