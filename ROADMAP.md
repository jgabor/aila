...
| Field                    | Value                                                                                                                                                                                              |
| ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Last completed milestone | Milestone 7: CLI Command Shape                                                                                                                                                                     |
| Next milestone           | Milestone 8: Config Display Stub                                                                                                                                                                   |
| Active milestone         | none                                                                                                                                                                                               |
| Last updated             | 2026-05-13                                                                                                                                                                                         |
| Last validation          | M7 CLI/app targeted tests, TUI package tests, package no-IO guards, PTY startup/quit smoke, `go test ./...`, and `mage check` passed; human visual review skipped, no layout or hierarchy changed. |
