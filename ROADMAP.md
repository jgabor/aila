...
| Field                    | Value                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Last completed milestone | Milestone 47: Plan Capability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Next milestone           | Milestone 48: Build Capability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Active milestone         | none                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| Last updated             | 2026-05-17                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| Last validation          | M47 plan capability validated with deterministic `plan` behavior over app-supplied project/session state; one exit payload carrying typed plan items, behavioral acceptance criteria, done/pending state, blockers, next action, artifact/source refs, and store/context/state boundary descriptors; valid PLAN successor recommendation when the FSM accepts the request phase; app-owned exact `/plan` route persisting `.aila/artifacts/plan.md` through `state.Store` as `OwnerApp`; TUI plan render plus semantic snapshots exposing items, blockers, artifact refs, source refs, `transition_claimed=false`, and `display_only=true`; PTY smoke proving visible `/plan` output and written plan artifact; behavior-named tests only; full internal and cmd tests; final `mage check` with 0 lint issues and no vulnerabilities; and changed-line home-path plus `TestM<number>` hygiene. |
