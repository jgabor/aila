...
| Field                    | Value                                                                                                                                                                                                                                                                                                                                 |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Last completed milestone | Milestone 24: go-agent Read-Only Turn                                                                                                                                                                                                                                                                                                 |
| Next milestone           | Milestone 25: Approval UI Without Mutation                                                                                                                                                                                                                                                                                            |
| Active milestone         | none                                                                                                                                                                                                                                                                                                                                  |
| Last updated             | 2026-05-16                                                                                                                                                                                                                                                                                                                            |
| Last validation          | M24 go-agent runner adapter tests, app read-only agent prompt/tool dispatch tests, build-active and provider failure render/semantic snapshots at 80x24 and 120x32, read-only/provider-failure PTY smoke, targeted tests, full internal tests, full `mage check`, architecture checklist evidence, and `git diff --check` all passed. |
