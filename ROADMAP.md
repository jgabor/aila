...
| Field                    | Value                                                                                                                                                                                                                                                                                  |
| ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Last completed milestone | Milestone 16: Session Snapshot Resume                                                                                                                                                                                                                                                  |
| Next milestone           | Milestone 17: History View For Fake Events                                                                                                                                                                                                                                             |
| Active milestone         | none                                                                                                                                                                                                                                                                                   |
| Last updated             | 2026-05-16                                                                                                                                                                                                                                                                             |
| Last validation          | M16 session snapshot state tests, explicit app persistence and continue/resume tests, idle-with-memory render/semantic snapshots, PTY resume/no-memory smoke, targeted state/app/TUI/cmd tests, full `mage check`, architecture checklist evidence, and `git diff --check` all passed. |
