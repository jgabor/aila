...
| Field                    | Value                                                                                                                                                                                                                                                                                                                                                         |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Last completed milestone | Milestone 21: Fetch Tool                                                                                                                                                                                                                                                                                                                                      |
| Next milestone           | Milestone 22: Permission Model For Read-Only Work                                                                                                                                                                                                                                                                                                             |
| Active milestone         | none                                                                                                                                                                                                                                                                                                                                                          |
| Last updated             | 2026-05-16                                                                                                                                                                                                                                                                                                                                                    |
| Last validation          | M21 fetch contract and fakeable executor tests, app/runtime fetch-effect and permission metadata tests, fetch render/semantic tests, fetch-success/fetch-failure/fetch-running fixtures and snapshots, PTY smoke skipped because no visible fetch command path exists, full `mage check`, architecture checklist evidence, and `git diff --check` all passed. |
