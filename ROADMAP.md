...
| Field                    | Value                                                                                                                                                                                                                                                                                                                                              |
| ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Last completed milestone | Milestone 19: Find And Grep Tools                                                                                                                                                                                                                                                                                                                  |
| Next milestone           | Milestone 20: Safe Bash Inspection                                                                                                                                                                                                                                                                                                                 |
| Active milestone         | none                                                                                                                                                                                                                                                                                                                                               |
| Last updated             | 2026-05-16                                                                                                                                                                                                                                                                                                                                         |
| Last validation          | M19 find/grep contract and executor tests, app/runtime search-effect and permission tests, search render/semantic tests, file-search/content-search/search-running fixtures and snapshots, PTY smoke skipped because no visible search command path exists, full `mage check`, architecture checklist evidence, and `git diff --check` all passed. |
