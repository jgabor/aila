...
func TestStatusCommandBuildsAppOwnedRuntimeInspectionSurface(t *testing.T) {
	...
	for _, want := range []string{
		...
		"utility job: stale_context_check status-stale-context-check",
		"utility summary: saved context appears stale",
		"utility stale context: stale",
		"utility stale context summary: saved context appears stale refs=stale-context-saved,stale-context-current",
		"utility stale context caveat: stale status is advisory; no context was refreshed, compacted, or rewritten",
		"utility suggested next action: Rebuild foreground context before relying on saved context.",
		"utility suggestion: Rebuild foreground context before relying on saved context. refs=stale-context-saved,stale-context-current",
		"utility evidence: stale-context-saved context_fingerprint saved context saved=saved-context:utility-context-prep",
		"utility evidence: stale-context-current context_fingerprint current runtime status current=current-context:status-runtime",
		"utility caveat: stale status is advisory; no context was refreshed, compacted, or rewritten",
