...
func TestCommandRoutesAreClosedPolicyRecommendations(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "discuss", input: "/discuss", want: CommandRouteDiscuss},
		{name: "research", input: "/research", want: CommandRouteResearch},
		{name: "profile", input: "/profile", want: CommandRouteProfile},
		{name: "plan", input: "/plan", want: CommandRoutePlan},
		{name: "build", input: "/build", want: CommandRouteBuild},
		{name: "optimize", input: "/optimize", want: CommandRouteOptimize},
		{name: "document", input: "/document", want: CommandRouteDocument},
		{name: "design", input: "/design", want: CommandRouteDesign},
		{name: "orchestrate", input: "/orchestrate", want: CommandRouteOrchestrate},
